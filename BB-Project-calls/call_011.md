...
We also want to say welcome to Danijel– who is our bot master on Discord. Maybe some of you have seen him before. This guy is pretty much the central nervous system for the entire Discord DeFi ecosystem. If you're in a server with price bots or anything, this is your guy. He pretty much runs DeFi's entire bot infrastructure. 
...
**Setting consensus:**
* !setConsensus 2
  - I did set a bunch of validations as well. So if you try and make the consensus higher than your members, the bot will return a prompt telling you to add members. For example, if I have two members and try to set consensus to three, the bot will say– there are not enough members in the squad. 
...
* From: **Troy**
  ...
  - **Milad:** Those are the main things. There are two pluggable components for the Smart Yield that the DAO can change. 
The Oracle: Calculates the yield generated by the pool (3-day avg.)
The algorithm/formula that offers the Senior Bond a yield can change
